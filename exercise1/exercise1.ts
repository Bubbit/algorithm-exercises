...
// Tree representation
const g: MyNode = { value: 14, left: undefined, right: undefined };
const f: MyNode = { value: 10, left: undefined, right: undefined };
const e: MyNode = { value: 25, left: undefined, right: undefined };
const d: MyNode = { value: 12, left: f, right: g };
const c: MyNode = { value: 4, left: undefined, right: undefined };
const b: MyNode = { value: 22, left: undefined, right: e };
